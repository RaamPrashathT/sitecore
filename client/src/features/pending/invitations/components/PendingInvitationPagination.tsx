...
interface PendingInvitationPaginationProps {
...
const PendingInvitationPagination = ({ table }: PendingInvitationPaginationProps) => {
...
export default PendingInvitationPagination;