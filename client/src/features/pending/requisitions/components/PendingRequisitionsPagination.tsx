...
interface PendingRequisitionPaginationProps {
...
const PendingRequisitionPagination = ({ table }: PendingRequisitionPaginationProps) => {
...
export default PendingRequisitionPagination;