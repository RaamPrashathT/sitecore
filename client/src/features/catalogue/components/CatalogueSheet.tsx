...
export default function CatalogueSheet({
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent
                side="right"
                className="w-full p-0 sm:max-w-[50vw] overflow-hidden flex flex-col"
            >   
                            ...
                            <div className="sticky top-0 z-10 shrink-0 border-b border-border bg-background">
                                <div className="flex items-center justify-between px-6 py-4">
                                    ...
                                    {membership && (
                                        ...
                                        >
                                            <Link
                                                to={`/${membership.slug}/catalogue/${catalogueId}/edit`}
                                                onClick={() =>
                                                    onOpenChange(false)
                                                }
                                            >
                                ...
                                <section className="flex flex-col gap-4">
                                    <div className="flex items-center justify-between border-b border-border pb-2">
                                        ...
                                        {membership && (
                                            ...
                                            >
                                                <Link
                                                    to={`/${membership.slug}/catalogue/${catalogueId}/quotes/add`}
                                                    onClick={() =>
                                                        onOpenChange(false)
                                                    }
                                                >
                                                                        ...
                                                                        {membership && (
                                                                            <DropdownMenu>
                                                                                ...
                                                                                <DropdownMenuContent align="end">
                                                                                    ...
                                                                                    >
                                                                                        <Link
                                                                                            to={`/${membership.slug}/catalogue/${catalogueId}/quotes/${item.id}/edit`}
                                                                                            onClick={() =>
                                                                                                onOpenChange(
                                                                                                    false,
                                                                                                )
                                ...
                                <section className="flex flex-col gap-4">
                                    <div className="flex items-center justify-between border-b border-border pb-2">
                                        ...
                                        {membership && (
                                            ...
                                            >
                                                <Link
                                                    to={`/${membership.slug}/catalogue/${catalogueId}/inventory/add`}
                                                    onClick={() =>
                                                        onOpenChange(false)
                                                    }
                                                >
                                                                        ...
                                                                        {membership && (
                                                                            <DropdownMenu>
                                                                                ...
                                                                                <DropdownMenuContent align="end">
                                                                                    ...
                                                                                    >
                                                                                        <Link
                                                                                            to={`/${membership.slug}/catalogue/${catalogueId}/inventory/${item.id}/edit`}
                                                                                            onClick={() =>
                                                                                                onOpenChange(
                                                                                                    false,
                                                                                                )
