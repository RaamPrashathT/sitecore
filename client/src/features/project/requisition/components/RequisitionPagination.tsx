...
interface RequisitionPaginationProps {
...
const EngineerDashboardPagination = ({ table }: RequisitionPaginationProps) => {
    ...
    return (
        <div className="flex flex-row relative">
            <Field className="flex flex-row w-80 items-center gap-x-1">
...
export default EngineerDashboardPagination;