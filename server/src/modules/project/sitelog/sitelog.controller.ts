...
const sitelogController = {
    ...
    async createComment(request: Request, response: Response) {
        try {
            ...
            const validatedParams = imageIdParamSchema.safeParse(request.params);
            if (!validatedParams.success) {
    ...
    async deleteComment(request: Request, response: Response) {
        try {
            ...
            const validatedParams = commentIdParamSchema.safeParse(request.params);
            if (!validatedParams.success) {
