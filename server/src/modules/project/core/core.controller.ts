...
const coreController = {
    ...
    async updateProject(request: Request, response: Response) {
        try {
            ...
            const result = await coreService.updateProject(
                projectId,
                validatedData.data,
            );
    ...
    async getMembers(request: Request, response: Response) {
        try {
            ...
            const result = await coreService.getMembers(
                projectId,
                organizationId,
            );
            return response.status(200).json(result);
    ...
    async assignMember(request: Request, response: Response) {
        try {
            ...
            return response
                .status(200)
                .json({ message: "Member assigned successfully" });
        } catch (error) {
    ...
    async removeMember(request: Request, response: Response) {
        try {
            ...
            await coreService.removeMember(
                projectId,
                validatedData.data.userId,
            );
