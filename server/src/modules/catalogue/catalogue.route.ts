...
catalogueRouter.get(
  ...
  orgAuthorize,
  requiredRole("ADMIN"),
  catalogueController.getCatalogue,
);
...
catalogueRouter.post(
  ...
  orgAuthorize,
  requiredRole("ADMIN"),
  suppliersController.restoreSupplier,
);

catalogueRouter.get(
  "/suppliers/:supplierId/quotes",
  authorize,
  orgAuthorize,
  requiredRole("ADMIN"),
  supplierQuotesController.getQuotesBySupplierId,
);

catalogueRouter.get(
  "/suppliers/:supplierId/catalogue-items",
  authorize,
  orgAuthorize,
  requiredRole("ADMIN"),
  suppliersController.getCatalogueItemsBySupplierId,
);
...
catalogueRouter.get(
  ...
  orgAuthorize,
  requiredRole("ADMIN"),
  supplierQuotesController.getSupplierQuotes,
);
...
catalogueRouter.get(
  ...
  orgAuthorize,
  requiredRole("ADMIN"),
  supplierQuotesController.getSupplierQuoteById,
);
...
catalogueRouter.post(
  ...
  orgAuthorize,
  requiredRole("ADMIN"),
  supplierQuotesController.createSupplierQuote,
);
...
catalogueRouter.patch(
  ...
  orgAuthorize,
  requiredRole("ADMIN"),
  supplierQuotesController.editSupplierQuote,
);
...
catalogueRouter.delete(
  ...
  orgAuthorize,
  requiredRole("ADMIN"),
  supplierQuotesController.deleteSupplierQuote,
);

// Quote history
catalogueRouter.get(
  "/supplier-quotes/:quoteId/history",
  authorize,
  orgAuthorize,
  requiredRole("ADMIN"),
  quoteHistoryController.getQuoteHistory,
);

catalogueRouter.get(
  "/supplier-quotes/:quoteId/history/:historyId",
  authorize,
  orgAuthorize,
  requiredRole("ADMIN"),
  quoteHistoryController.getQuoteHistoryById,
);
...
catalogueRouter.patch(
  ...
  orgAuthorize,
  requiredRole("ADMIN"),
  catalogueController.editCatalogue,
);
...
catalogueRouter.get(
  ...
  orgAuthorize,
  requiredRole("ADMIN"),
  supplierQuotesController.getQuotesByCatalogueId,
);

catalogueRouter.get(
  "/:catalogueId/suppliers",
  authorize,
  orgAuthorize,
  requiredRole("ADMIN"),
  suppliersController.getSuppliersByCatalogueId,
);
